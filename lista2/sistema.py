...
class AVL:
  ...
  def insert(self, node, key):
    ...
    node.height = 1 + max(self.height(node.left, True), self.height(node.right, True))
  ...
  def delete(self, node, key, silent=True):
    ...
    if node is None:
      ...
      if self.root.left is None and self.root.right is None and key.lower() == self.root.key.lower():
        self.root = None
        return self.root
  ...
  def leftRotate(self, node):
    ...
    node.height = 1 + max(self.height(node.right, True), self.height(node.right, True))
    rightSubTree.height =  1 + max(self.height(rightSubTree.right, True), self.height(rightSubTree.right, True))
  ...
  def rightRotate(self, node):
    ...
    node.height = 1 + max(self.height(node.right, True), self.height(node.right, True))
    leftSubTree.height =  1 + max(self.height(leftSubTree.right, True), self.height(leftSubTree.right, True))
